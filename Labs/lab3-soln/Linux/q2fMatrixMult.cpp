...
void init(void)
{
    ...
    GLuint program = InitShader("q2eMatrixMult-v.glsl", "q2b-2sincos-f.glsl");
...
void display(void)
{
    ...
    mat2 multipliers_mat = mat2(vec2(0.65*cos(angle), -0.65*sin(angle)),
                                 vec2(0.5*sin(angle),  0.5*cos(angle)));
